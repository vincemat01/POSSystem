...
import { Home, ShoppingCart, Package, Wallet, MoreHorizontal, Boxes, ClipboardList, Truck, ShoppingBag, Users, UserPlus, Receipt, History, BarChart3, CalendarClock, Settings, Banknote } from "lucide-react";
